  ...
  return (
    <div className="AboutContent ">
      <section className="aboutSection">
        <p className={pStyle}>
          I am a passionate Full Stack Web Developer with a unique background in
          Radiology Technology. With a degree in Radiology Technology and four
          years of practical experience in the field, I have honed my attention
          to detail and problem-solving skills, which seamlessly translate into
        ...
        <p className={pStyle}>
          ...
          myself in the MERN stack (MongoDB, Express.js, React.js, and Node.js),
          mastering the tools and technologies necessary to create dynamic and
        ...
        <p className={pStyle}>
          ...
          simply like to chat, feel free to reach out. Let's bring your ideas to
          life together!
        </p>
        <br />
        <p className={pStyle}>
